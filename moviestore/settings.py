...
Generated by 'django-admin startproject' using Django 6.2.dev20260829175241.
...
SECRET_KEY = 'django-insecure-zx&+!zlb!0oqxnd@tf!18f73*bz#&4pxsk#ykp&bgc9*_ptq4d'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    "hlli885.pythonanywhere.com",
    "127.0.0.1",
    "localhost",
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/"moviestore"/"templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
